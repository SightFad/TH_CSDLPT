...
SELECT * FROM mssql_site_a_112541.Shop.dbo.KhoHang
WHERE MaKhoHang = 1
UNION ALL
SELECT * FROM mssql_site_b_112541.Shop.dbo.KhoHang
WHERE MaKhoHang = 2;
GO
...
SELECT * FROM mssql_site_a_112541.Shop.dbo.ChiTietHoaDon
WHERE MaHoaDon BETWEEN 10001 AND 110000
UNION ALL
SELECT * FROM mssql_site_b_112541.Shop.dbo.ChiTietHoaDon
WHERE MaHoaDon BETWEEN 110001 AND 210000;
GO