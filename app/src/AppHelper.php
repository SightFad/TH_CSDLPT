...
function callBuyAPI(int $maKhachHang, array $orders)
{
  ...
  $apiUrl = 'http://api_php_112541:8080/api/transactions/buy';
...
function GetKH()
{
  ...
  $apiUrl = 'http://api_php_112541:8080/api/KhachHang/random';
...
function GetSP()
{
  ...
  $apiUrl = 'http://api_php_112541:8080/api/SanPham/random';
